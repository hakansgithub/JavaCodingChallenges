    ...
    public void putTogetherTheStory () {
        ...
        if (num == 0) {
            ...
            story = "Amanda and her frenemy " + getName() + " went to the zoo last summer. " +
                    "They saw a huge " + getNoun1() + " and a tinly little " + getNoun2() + ". That night"
                    + " they decided to climb " + getAdverb() + " into the " + getNoun3() + " to get a " +
                    "closer look." + " The zoo was " + getRandomNums() + " " + getAdjective2() + " apes " +
                    "yelled in their faces, making Amanda and " + getName() + " sprint all the way" +
                    "back home.";
        }
        setStory(story);
    }
